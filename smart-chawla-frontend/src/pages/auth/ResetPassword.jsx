...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-[#fcfaff] py-6 px-4">
      <Helmet>
        <title>Reset Password | Smart Chawla</title>
        <meta
          name="description"
          content="Set a new secure password for your Smart Chawla account."
        />
        <link
          rel="canonical"
          href={`https://smart-chawla.vercel.app/reset-password/${token}`}
        />
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>
