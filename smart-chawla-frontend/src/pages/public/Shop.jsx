...
const Shop = () => {
  ...
  }, [pagination.page, pagination.limit, searchQuery, selectedCategories, priceRange, sortBy, inStockOnly, isFeatured]);
              ...
              <div key={index} className="flex items-center gap-2">
                ...
                {item.url ? (
                  ...
                  >
                    ...
                    <span className={item.icon ? 'font-bangla' : ''}>{item.name}</span>
                  </Link>
                ) : (
                  <span className="text-primary-600 font-semibold font-bangla flex items-center gap-1.5">
                    {item.icon && <item.icon className="w-4 h-4" />}
                    {item.name}
                  </span>
                )}
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white py-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2 font-bangla animate-fade-in">
                {searchQuery ? (
              ...
              <p className="text-primary-100 text-lg font-bangla">
                {pagination.total}টি পণ্য পাওয়া গেছে
              </p>
            </div>
            ...
            <div className="flex gap-4 text-sm">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20">
                <span className="block text-3xl font-bold">{pagination.total}</span>
                <span className="text-primary-200 font-bangla text-xs uppercase tracking-wider">মোট পণ্য</span>
              </div>
              {selectedCategories.length > 0 && (
                <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20">
                  <span className="block text-3xl font-bold">{selectedCategories.length}</span>
                  <span className="text-primary-200 font-bangla text-xs uppercase tracking-wider">ক্যাটাগরি</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="hidden lg:block lg:w-72 flex-shrink-0">
            <div className="sticky top-4 space-y-6">
              ...
              {/* Price Range Filter */}
              <div className="bg-white rounded-2xl shadow-soft border border-neutral-100 overflow-hidden animate-slide-up" style={{animationDelay: '0.1s'}}>
                <div className="p-4 border-b border-neutral-100 bg-neutral-50/50">
                  <h3 className="font-semibold text-neutral-800 font-bangla">মূল্য পরিসীমা</h3>
                </div>
                <div className="p-4 space-y-4">
                  <div className="flex gap-3">
                    <div className="flex-1">
                      <label className="text-xs text-neutral-500 mb-1.5 block font-bangla">সর্বনিম্ন</label>
                    ...
                    <div className="flex-1">
                      <label className="text-xs text-neutral-500 mb-1.5 block font-bangla">সর্বোচ্চ</label>
                      <div className="relative">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-400 text-sm">৳</span>
                        <input
                          type="number"
              ...
              {/* Availability Filter */}
              <div className="bg-white rounded-2xl shadow-soft border border-neutral-100 overflow-hidden animate-slide-up" style={{animationDelay: '0.2s'}}>
                <div className="p-4 border-b border-neutral-100 bg-neutral-50/50">
                  <h3 className="font-semibold text-neutral-800 font-bangla">প্রাপ্যতা</h3>
                </div>
                <div className="p-4 space-y-3">
                  <label className="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-neutral-50 transition-colors">
                    ...
                    />
                    <span className="text-sm text-neutral-700 group-hover:text-neutral-900 font-bangla">শুধুমাত্র স্টকে আছে</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-neutral-50 transition-colors">
                    <input
                      type="checkbox"
                      ...
                      className="w-5 h-5 text-primary-500 border-neutral-300 rounded-lg focus:ring-primary-500 focus:ring-2"
                    />
                    <span className="text-sm text-neutral-700 group-hover:text-neutral-900 font-bangla">ফিচার্ড পণ্য</span>
                  </label>
                </div>
              </div>
            ...
            >
              ...
              {hasActiveFilters && (
                <span className="bg-primary-500 text-white text-xs px-2.5 py-1 rounded-full font-bold">
                  {selectedCategories.length + (priceRange.min || priceRange.max ? 1 : 0) + (inStockOnly ? 1 : 0) + (isFeatured ? 1 : 0)}
                </span>
              )}
            </button>
          </div>
            ...
            <>
              ...
              <div className="fixed inset-y-0 left-0 w-80 bg-white z-50 overflow-y-auto lg:hidden shadow-2xl">
                <div className="p-4 border-b border-neutral-100 flex items-center justify-between bg-neutral-50">
                  <h2 className="font-bold text-lg text-neutral-800 font-bangla">ফিল্টার</h2>
                  <button 
                    onClick={() => setShowMobileFilters(false)}
                ...
                <div className="p-4 space-y-6">
                  <div>
                    <h3 className="font-semibold mb-3 text-neutral-800 font-bangla">ক্যাটাগরি</h3>
                    <CategorySidebar 
                      selectedCategories={selectedCategories}
                      onCategoryChange={handleCategoryChange}
                    />
                  ...
                  <div className="border-t border-neutral-100 pt-6">
                    <h3 className="font-semibold mb-3 text-neutral-800 font-bangla">মূল্য পরিসীমা</h3>
                  ...
                  <div className="border-t border-neutral-100 pt-6 space-y-3">
                    <label className="flex items-center gap-3">
                      ...
                      />
                      <span className="font-bangla text-neutral-700">শুধুমাত্র স্টকে আছে</span>
                    </label>
                    <label className="flex items-center gap-3">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-primary-500 rounded"
                      />
                      <span className="font-bangla text-neutral-700">ফিচার্ড পণ্য</span>
                    </label>
                  </div>
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded-2xl shadow-soft border border-neutral-100 p-4 mb-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="text-sm text-neutral-600 font-bangla">
                  ...
                  {Math.min(pagination.page * pagination.limit, pagination.total)} এর মধ্যে{' '}
                  {pagination.total}টি পণ্য
                </div>
                    ...
                    >
                      {sortOptions.map(option => (
                        <option key={option.value} value={option.value}>
                          {option.label === 'Newest First' && 'নতুন থেকে পুরাতন'}
                          {option.label === 'Oldest First' && 'পুরাতন থেকে নতুন'}
                          {option.label === 'Price: High to Low' && 'দাম: বেশি থেকে কম'}
                          {option.label === 'Price: Low to High' && 'দাম: কম থেকে বেশি'}
                          {option.label === 'Highest Rated' && 'রেটিং অনুযায়ী'}
                          {option.label === 'Most Popular' && 'জনপ্রিয়তা অনুযায়ী'}
                        </option>
                      ))}
                    </select>
              ...
              {hasActiveFilters && (
                <div className="mt-4 pt-4 border-t border-neutral-100 animate-fade-in">
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-sm text-neutral-500 font-bangla">সক্রিয় ফিল্টার:</span>
                    {selectedCategories.map((catId, idx) => (
                      ...
                      >
                        ...
                        <button 
                          onClick={() => handleCategoryChange(selectedCategories.filter(c => c !== catId))}
            ...
            {loading ? (
              ...
              <div className="text-center py-16 bg-white rounded-2xl border border-neutral-100 shadow-soft">
                ...
                <h3 className="text-xl font-semibold text-neutral-800 mb-2 font-bangla">কোনো পণ্য পাওয়া যায়নি</h3>
                <p className="text-neutral-500 mb-6 font-bangla">আপনার ফিল্টার পরিবর্তন করুন বা অন্য কিছু সার্চ করুন</p>
                {hasActiveFilters && (
                  <button
                    onClick={clearAllFilters}
                    ...
                    <div className="flex items-center gap-2 bg-white p-2 rounded-2xl shadow-soft border border-neutral-100">
                      ...
                      {[...Array(pagination.pages)].map((_, i) => {
                        ...
                        if (
                          ...
                          return <span key={i} className="text-neutral-400 px-1">...</span>;
                        }
                        return null;
                      })}
